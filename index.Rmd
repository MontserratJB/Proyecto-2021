...
acuarela <-
  rast(
    "/vsicurl/https://github.com/MontserratJB/Proyecto-2021/blob/master/acuarela_wgs.tif?raw=true"
  )
```
...
acuarela_rl <- raster::raster(acuarela)
...
addMeasurePathToolbar(
  ...
  addLayersControl(
    baseGroups = c("Toner","ESRI","Acuarela"),
